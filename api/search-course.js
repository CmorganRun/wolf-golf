...
Use your training knowledge of golf courses. "si" = stroke index 1-18 (1=hardest hole). If you truly don't know this specific course return {"found":false}.`;
  ...
  try {
    ...
    catch(e) { return res.status(200).json({ found: false }); }
